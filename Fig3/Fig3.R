...
tiff(file="Fig3.tif",res=30,width=5000,height=2500)
par(mfrow=c(2,1))
...
rect(163812180, -100,163809600 ,100, cex=1, col=rgb(0.7,0.6,0.1,alpha=0.2),lwd=10,bty="n",border="transparent")
box(lwd=15)

read.table("SRR12868140.1_163800000_163821000.GSGJ.bam.10bpcov") ->b
lines(b$V2,b$V4,xlim=c(163807042,163814484),xlab="",ylab=c(expression(paste(bold("Mean coverage in 10 bases")))),col="grey",cex.main=25, cex.lab=12, cex.axis=15,cex =10, font.axis=2,lwd=40,xaxt='n',yaxt='n',ylim=c(0,85))
axis(2, lwd = 15,tck = -0.02,cex.axis=10,font = 2)


read.table("SRR8362940.1_163800000_163821000.GSGJ.bam.10bpcov") ->b
lines(b$V2,b$V4,xlim=c(163807042,163814484),xlab="",ylab=c(expression(paste(bold("Mean coverage in 10 bases")))),col="green",cex.main=25, cex.lab=12, cex.axis=15,cex =10, font.axis=2,lwd=40,xaxt='n',yaxt='n',ylim=c(0,85))
axis(2, lwd = 15,tck = -0.02,cex.axis=10,font = 2)


read.table("1_163800000_163821000.gsgj.txt") ->a
read.table("SRR8362948.1_163800000_163821000.GSGJ.bam.10bpcov") ->b
lines(b$V2,b$V4,xlim=c(163807042,163814484),xlab="",ylab=c(expression(paste(bold("Mean coverage in 10 bases")))),col="magenta",cex.main=25, cex.lab=12, cex.axis=15,cex =10, font.axis=2,lwd=40,xaxt='n',yaxt='n',ylim=c(0,85))
axis(2, lwd = 15,tck = -0.02,cex.axis=10,font = 2)
